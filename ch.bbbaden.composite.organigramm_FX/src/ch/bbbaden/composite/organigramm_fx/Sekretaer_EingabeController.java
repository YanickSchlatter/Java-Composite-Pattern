 ...
 * @author Admin
 */
public class Sekretaer_EingabeController implements Initializable {

    private AnchorPane ap_SEK;
    @FXML
    ...
    private void handleButtonAction_Einlesen(ActionEvent event) throws IOException {
        ...
        System.out.println("Sekretär wird erstellt\n");
        
        Mitarbeiter_Liste.addMitarbeiter(Tf_Name1.getText(), "Sekretär");
        System.out.println("Sekretär wurde erstellt\n");
